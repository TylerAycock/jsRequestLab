...
////////////////////////////////////////////////
const localHost = 'http://localhost:3000/say-hello'
// PROBLEM 1
/*
...
const ohMy = () => {
    ...
    .then((response)=>{
        for(let i =0; i< response.data.length; i++ ){
            ...
            blurb.textContent = response.data[i]
...
const requestButton = event => {
    axios.get('http://localhost:3000/query-test?pizza?pasta')
    .then(response => {
...
document.getElementById(`query-button`).addEventListener(`click`, requestButton)
